...
import com.luiza.helpdesk.domain.enuns.Prioridade;
import com.luiza.helpdesk.domain.enuns.Status;
import com.luiza.helpdesk.repositories.ChamadoRepository;
...
public class DBService {
	...
	public void instanciaDB() {
		...
		Tecnico tec1 = new Tecnico(null, "Maria Luiza", "550.482.150-95", "maria@mail.com", encoder.encode("123"));
